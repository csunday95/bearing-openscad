...
translate([outer_bound, outer_bound, 0])
    inner_race(height, id, od, lip_thickness, lip_depth, 4, 0.25);
...
translate([-outer_bound, -outer_bound, 0])
    outer_race(height, od + roller_radius * 2 - lip_depth * 2, od + 2, lip_thickness, lip_depth, notches=16, notch_depth=0.25);
